...
int main (int argc, char *argv[])
{
	...
	cudaMemAdvise(a, sizeof(float)*SIZE, cudaMemAdviseSetAccessedBy, device);
	cudaMemAdvise(b, sizeof(float)*SIZE, cudaMemAdviseSetAccessedBy, device);
	...
	cudaMemAdvise(c, sizeof(float)*SIZE, cudaMemAdviseSetAccessedBy, device);
